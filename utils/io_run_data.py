...
def export_details_and_infos_yaml(dump_path, details, infos):
    ...
    output_details_yaml = export_path_root + f'/run_details.yaml'
    output_run_infos_yaml = export_path_root + f'/run_infos.yaml'
...
def build_folder_if_not_exists(folder_path):
